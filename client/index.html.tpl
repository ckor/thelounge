...
<head>
	...
	<% _.forEach(stylesheets, function(css) { %>
		...
		<% }); %>
			...
			<title>Chat LOGEA</title>

			<!-- Browser tab icon -->
			<link id="favicon" rel="icon" sizes="16x16 32x32 64x64" href="favicon.ico"
				data-other="img/favicon-alerted.ico" type="image/x-icon">
		...
		<div id="loading">
			<div class="window">
				<div id="loading-status-container">
					...
					<img src="img/logo-vertical-transparent-bg-inverted.svg" class="logo-inverted" alt="" width="256"
						height="170">
					<p id="loading-page-message">Le navigateur n'est pas supporté ou JavaScript n'est pas activé</p>
				</div>
				<div id="loading-reload-container">
					<p id="loading-slow">Cela prends plus de temps qu'il ne devrai, il doit y avoir un problème de
						connexion.</p>
					<button id="loading-reload" class="btn">Recharger la page</button>
				</div>
			</div>
		</div>
